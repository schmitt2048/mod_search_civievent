...
if ($params->get('opensearch', 1)) {
	...
	$doc->addHeadLink(JURI::getInstance()->toString(array('scheme', 'host', 'port')).JRoute::_('&option=com_search_civievent&format=opensearch'), 'search', 'rel', array('title' => htmlspecialchars($ostitle), 'type' => 'application/opensearchdescription+xml'));
}
...
require JModuleHelper::getLayoutPath('mod_search_civievent', $params->get('layout', 'default'));
